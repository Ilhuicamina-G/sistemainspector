...
<<<<<<< HEAD
    ...
    public AlertDialog createLoginDialogo() {
        ...
        View v = inflater.inflate(R.layout.alert_dialog_cambiourl, null);

        editText = (EditText) findViewById(R.id.nuevourl);

        builder.setView(v);

        builder.setPositiveButton("Nueva URL", new DialogInterface.OnClickListener() {
            @Override
